function  [Z] =  Gernalized_LFCTNN_FL( HSI, MSI,R,FBm,sf,S,para,ii,aaa,iii)
K=para.K;
eta=para.eta(1);
eta2=para.eta(2);
eta3=para.eta(3);
...
D2=imresize(D2,sf);
path='G:\2024ÊµÑématlab\WDC\';
filename = [path 'fusion_ros2e2e3_0904.xls']; 
...
V1=Log_prox_tnn_FC(XES, eta/2/mu );%_2 
...
V2=Log_prox_tnn_FC(XES, eta2/2/mu );%_2 
V2=permute(V2,[1,3,2]);
...
V3=Log_prox_tnn_FC(XES, eta3/2/mu );
V3=permute(V3,[3,1,2]);
