function  [Z] =  Gernalized_LFCTNN_FL( HSI, MSI,R,FBm,sf,S,para,aaa)
K=para.K;
eta=para.eta(1);
eta2=para.eta(2);
eta3=para.eta(3);
...
V1=Log_prox_tnn_FL(XES, eta/2/mu );%_2 
...
V2=Log_prox_tnn_FL(XES, eta2/2/mu );%_2 
V2=permute(V2,[1,3,2]);
...
V3=Log_prox_tnn_FL(XES, eta3/2/mu );
V3=permute(V3,[3,1,2]);
